...
\newcommand{\mystudent}[1]{\item~\label{#1} \fullcite{\detokenize{#1}}}
...
\begin{enumerate}
    \mystudent{guolongzheng}
    \begin{itemize}
    \item supported through ARO and NSF 
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}
    \mystudent{didierishimwe}
    \begin{itemize}
    \item supported through NSF and Startup
    \end{itemize}
    \mystudent{linhanli}
    \begin{itemize}
    \item supported through NSF
    \end{itemize}
    \mystudent{haiduong}
    \begin{itemize}
    \item supported through Startup
    \end{itemize}
\end{enumerate}
